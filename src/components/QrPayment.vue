        ...
        <div class="qr-payment__contact-btns">
          <button class="qr-payment__contact-btn" @click="copyToClipboard('826857706', 'QQ号已复制，请前往QQ添加好友')">
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
              <path d="M12.003 2C6.004 2 3.002 6.044 3.002 9.5c0 1.724.534 3.508 1.562 4.938-.168.642-.742 1.856-1.462 2.658-.152.172-.044.424.18.418 1.26-.032 3.16-.7 4.046-1.186A8.31 8.31 0 0012.003 15c5.997 0 9-4.044 9-7.5S18 2 12.003 2zm-2.54 5.186a1.066 1.066 0 110 2.132 1.066 1.066 0 010-2.132zm5.08 0a1.066 1.066 0 110 2.132 1.066 1.066 0 010-2.132zM12 16c-1.2 0-2.326-.204-3.332-.574.06.784-.074 1.844-.778 2.758-.136.176.018.412.228.364.86-.198 1.96-.958 2.544-1.538.18.012.36.02.542.02 3.866 0 7-2.686 7-6S17.866 5 14 5c-.18 0-.36.008-.542.02C13.842 5.6 14 6.28 14 7c0 2.76-2.686 5-6 5-.182 0-.362-.008-.542-.02C7.468 13.042 9.558 16 12 16z"/>
            </svg>
